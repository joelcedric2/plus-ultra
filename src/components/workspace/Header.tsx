    ...
    <header className="h-16 bg-card/80 backdrop-blur-2xl flex items-center justify-between px-6 relative z-10">
      {/* Logo and Project Name */}
        ...
        <div className="flex items-center gap-3">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="start" className="w-64 bg-card border-border z-50 p-3">
              <DropdownMenuItem className="gap-3 cursor-pointer hover:bg-accent/10 hover:text-foreground focus:bg-accent/10 focus:text-foreground mb-2">
              ...
              <DropdownMenuItem className="gap-3 cursor-pointer hover:bg-accent/10 hover:text-foreground focus:bg-accent/10 focus:text-foreground">
        ...
        <Button
          ...
          className="h-8 w-8 p-0 hover:bg-primary/10 rounded-lg transition-all mr-12 relative z-20"
        >
