...
export const ChatPane = () => {
  ...
  return <div className="h-full flex flex-col bg-background/50 backdrop-blur-xl border-r border-border/30">
      ...
      <div className="p-5 border-t border-border/30 bg-card/30 backdrop-blur-xl">
        ...
        }} placeholder="Describe your app or feature..." rows={1} className="w-full resize-none bg-transparent border-0 focus-visible:ring-0 focus-visible:ring-offset-0 rounded-xl py-1 px-4 pr-20 placeholder:text-muted-foreground/50 max-h-[200px] overflow-y-auto leading-tight min-h-[40px]" style={{
          height: 'auto'
        }} />
